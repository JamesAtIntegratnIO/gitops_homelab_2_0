...
| Loki / Promtail | 3.7.6 / 2.7.3 | Loki moved to the community chart `grafana-community/loki` 18.11.0 -- grafana/loki 7.x is Grafana Enterprise Logs only. Promtail notably older, and EOL |
